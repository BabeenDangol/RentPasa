...
class BookService {
  ...
  static async createBook(userId,userName,phone,ownerId,propertyAddress, propertyLocality, propertyRent, propertyType, propertyBalconyCount, propertyBedroomCount, propertyDate,propertyDescriptions) {
    try {
      const book = new BookModel({userId,userName,phone,ownerId,propertyAddress, propertyLocality, propertyRent, propertyType, propertyBalconyCount, propertyBedroomCount, propertyDate,propertyDescriptions });
